    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-white/80 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in [animation-delay:300ms] opacity-0 [animation-fill-mode:forwards]">
          Discover the extraordinary flower that produces the world's most
          precious spice, cultivated for over 3,000 years and worth more than
          gold.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/about#saffron-timeline"
            className="animate-fade-in [animation-delay:450ms] opacity-0 [animation-fill-mode:forwards]"
          >
            <Button
              variant="default"
              size="lg"
              className="bg-saffron-gold hover:bg-saffron-gold/90 text-white font-semibold px-10 py-3 rounded-full shadow-elegant transition-all duration-300 hover:scale-105"
            >
              Learn More
            </Button>
          </Link>
          <Link
            to="/growing-guide"
            className="animate-fade-in [animation-delay:600ms] opacity-0 [animation-fill-mode:forwards]"
          >
            <Button
              variant="outline"
              size="lg"
